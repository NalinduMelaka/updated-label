...
import { createquantity } from '../actions/api/createquantity';
...
const Userinputforquntity = (props: Props) => {
  ...
  return (
    <tr>
      ...
      <td className='border border-black'><input type='text'onChange={(e) => setSellingprice(Number(e.target.value))} value={sellingprice} className='w-20 bg-white'/></td>
